export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	simisage: {
		...
		types: ["Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 100, def: 60, spa: 100, spd: 60, spe: 105 },
	...
	simisear: {
		...
		types: ["Fire"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 120, def: 65, spa: 65, spd: 65, spe: 110 },
		abilities: { 0: "Gluttony", 1: "Blaze", H: "Drought" },
		heightm: 1,
		weightkg: 28,
		color: "Red",
		prevo: "Pansear",
	...
	simipour: {
		...
		types: ["Water"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 60, def: 90, spa: 105, spd: 90, spe: 80 },
		abilities: { 0: "Gluttony", 1: "Torrent", H: "Drizzle" },
		heightm: 1,
		weightkg: 29,
		color: "Blue",
		prevo: "Panpour",
